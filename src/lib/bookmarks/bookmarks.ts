...
/** Deterministic id of the current user's bookmarks page (no lookup needed). */
export async function bookmarksPageId(): Promise<string> {
  const userId = await getCurrentUserId();
  return systemPageId(userId, "bookmark", BOOKMARKS_KEY);
}
