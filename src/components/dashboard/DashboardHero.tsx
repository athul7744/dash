  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex h-12 w-full max-w-xs items-center gap-3 rounded-full border border-border/70 bg-[var(--field-surface)] px-5 text-left text-sm text-muted-foreground shadow-[0_10px_30px_-24px_rgba(15,23,42,0.6)] transition-colors hover:border-border hover:text-foreground sm:max-w-md lg:max-w-lg"
      >
