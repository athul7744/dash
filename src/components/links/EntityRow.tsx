...
const ROW_CLASS =
  "flex w-full items-center gap-2 rounded-lg border border-border/60 bg-card/50 px-3 py-2 text-left text-sm transition-colors hover:border-border hover:bg-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
