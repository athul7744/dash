...
export function NotesNavigationRail({
  ...
  return (
    <div className="animate-fade-slide-in w-full space-y-3 py-1 sm:flex sm:h-full sm:w-full sm:min-w-0 sm:min-h-0 sm:flex-1 sm:flex-col sm:gap-3 sm:space-y-0 sm:overflow-hidden">
